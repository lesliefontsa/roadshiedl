    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('disponible', 'Disponible'), ('en_route', 'En Route'), ('maintenance', 'En Maintenance'), ('hors_service', 'Hors Service')], default='disponible', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trip_type', models.CharField(choices=[('aller', 'Aller Simple'), ('retour', 'Aller-Retour')], max_length=10)),
                ...
                ('status', models.CharField(choices=[('confirmed', 'Confirmée'), ('validated', 'Validée'), ('cancelled', 'Annulée'), ('refunded', 'Remboursée')], default='confirmed', max_length=20)),
